...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sahana/catkin_ws/install/${idir}'.  Ask the maintainer 'Martin Guenther <martin.guenther@dfki.de>, Murilo FM <muhrix@gmail.com>' to fix it.")
    endif()
