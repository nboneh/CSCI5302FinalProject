...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_imu_SOURCE_PREFIX /home/sahana/catkin_ws/src/phidgets_drivers/phidgets_imu)
  set(phidgets_imu_DEVEL_PREFIX /home/sahana/catkin_ws/devel)
  ...
  set(phidgets_imu_INSTALL_PREFIX /home/sahana/catkin_ws/install)
...
if(NOT "/home/sahana/catkin_ws/src/phidgets_drivers/phidgets_imu/include;/usr/include " STREQUAL " ")
  set(phidgets_imu_INCLUDE_DIRS "")
  set(_include_dirs "/home/sahana/catkin_ws/src/phidgets_drivers/phidgets_imu/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Martin Guenther <martin.guenther@dfki.de>, Murilo FM <muhrix@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sahana/catkin_ws/src/phidgets_drivers/phidgets_imu/${idir}'.  Ask the maintainer 'Martin Guenther <martin.guenther@dfki.de>, Murilo FM <muhrix@gmail.com>' to fix it.")
    endif()
